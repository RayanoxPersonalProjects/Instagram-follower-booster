...
//	public final static String ARG_NAME_MAIL_RECIPIENTS_ONLY_IMPORTANTS_MAILS 	= "mailRecipientsImportantsNotifs";
	...
	public void run(String... args) throws Exception {
		...
		try {
			bot.StartBooster(arguments.targetFollowerCount, arguments.forceStartANewUserInstance, arguments.skipWhitelistGeneration);
		}catch(Exception e) {
...
//		String mailRecipientsImportantsNotifs = ns.getString(ARG_NAME_MAIL_RECIPIENTS_ONLY_IMPORTANTS_MAILS);
		...
		return new Arguments(targetFollowers, forceNewStart, mailUsername, /*mailRecipientsImportantsNotifs, */mailPassword, mailRecipients, pythonPath, instaUsername, instaPassword, skipWhitelistGeneration);
	}

	
	private static class Arguments{
		public Arguments(int targetFollowerCount, boolean forceStartANewUserInstance, String mailUsername, String mailPassword, String mailRecipients, String pythonPath, String instaUsername, String instaPassword/*, String mailRecipientsImportantsNotifs*/, boolean skipWhitelistGeneration) {
